...
<head>
    ...
    <link rel="stylesheet" href="CSS/estiloCotHino.css">
    <title>Document</title>
</head>
<body>
    
    <header class="contenedor">
        <img src="IMG/logoHino.png" >
    </header>

    <div class="titulo">
        <h4>Cotice su próximo HINO ahora</h4>
    </div>

    <form action="confirmacionHino.php" method="post">
        <label for="modelo">Modelo a cotizar</label>
            <select id="modelo" name="modelo" required>
                <option value="" disabled selected hidden>-- Ninguno --</option>
                <option value="HINO 200 2 TON">HINO 200 2 TON</option>
                <option value="HINO 300 3.5 TON">HINO 300 3.5 TON</option>
                <option value="HINO 300 4.5 TON">HINO 300 4.5 TON</option>
                <option value="HINO 300 5.5 TON">HINO 300 5.5 TON</option>
                <option value="HINO 300 7 TON">HINO 300 7 TON</option>
                <option value="HINO 500 8 TON">HINO 500 8 TON</option>
                <option value="HINO 500 9.5 TON">HINO 500 9.5 TON</option>
                <option value="HINO 500 12 TON"</option">HINO 500 12 TON</option>
            </select>
